...
caffe.set_device(0)
caffe.set_mode_gpu()
solver = caffe.SGDSolver('examples/PARSE_HogConvssvm26_PCP6598/parse_hogconvssvm26_manual_loss_solver.prototxt')
...
net_init = caffe.Net('examples/PARSE_HogConvssvm26_PCP6598/parse_hogconv_respmaps_deploy.prototxt', 'examples/PARSE_HogConvssvm26_PCP6598/save/parse_hogconvssvm26_trainStart_160610_152006_trainStop_160611_064739.caffemodel', caffe.TEST)
...
savename = 'examples/PARSE_HogConvssvm26_PCP6598/save/parse_hogconvssvm26_trainStart_' + starttime+'_trainStop_'+ stoptime+'.caffemodel'
...
caffe.set_mode_cpu()
net_feat_def = '/working3/peerajak/ChulaQE/Semister9/1_caffe/examples/PARSE_HogConvssvm26_PCP6598/parse_hogconv_feat_deploy.prototxt'
...
savefeatname = '/working3/peerajak/ChulaQE/Semister9/1_caffe/examples/PARSE_HogConvssvm26_PCP6598/save/parse_hogconvssvm26_trainStart_' + starttime+'_trainStop_'+ stoptime+'_feat.caffemodel'
net_feat.save(savefeatname)

savelosswname = '/working3/peerajak/ChulaQE/Semister9/1_caffe/examples/PARSE_HogConvssvm26_PCP6598/save/parse_hogconvssvm26_trainStart_' + starttime+'_trainStop_'+ stoptime+'_lossw.mat'
...
os.chdir('MySubGradientSSVM_1_3_is_1_2')
