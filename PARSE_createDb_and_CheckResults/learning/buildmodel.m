function jointmodel = buildmodel(name,part_model,pa,def,idx,K)
...
jointmodel.maxsize  = part_model{1}.maxsize;
jointmodel.interval = part_model{1}.interval;
jointmodel.len = 0;
